...
const Auth = () => {
  const [Email, setEmail] = useState('');//this
  const [Name, setName] = useState('');//thisss
  const [Password, setPassword] = useState('');//thiss
  ...
  const register = useCallback(async () => {
    try {
      console.log("client -> register payload:", { email, name, password });
